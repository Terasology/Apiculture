...
public class BeeCommands extends BaseComponentSystem {
    @Command(shortDescription = "Shows the genes of a held bee",
    ...
    public String dumpGenes(@Sender EntityRef client) {
        GeneticsComponent genetics = client.getComponent(ClientComponent.class).character.getComponent(CharacterHeldItemComponent.class).selectedItem.getComponent(GeneticsComponent.class);
        if (genetics != null) {
        ...
        return "Held item contains no genetic information.";
    }
}
